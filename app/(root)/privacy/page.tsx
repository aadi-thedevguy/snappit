    ...
    sections={[
      {
        ...
        content: (
          <p>
            We process your account details, uploaded recordings and metadata,
            and basic usage or security logs needed to operate Snappit.
          </p>
        ),
      },
      {
        ...
        content: (
          <p>
            We use this information to provide, secure, maintain, and improve
      ...
      },
      {
        ...
        content: (
          <p>
            Recordings are stored with our cloud providers and are generally
            retained for up to one month. Public share links can be viewed by
            anyone who has the link. We only share data with service providers
