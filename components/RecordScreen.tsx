      ...
      const captureThumbnail = () => {
        ...
        if (video && canvas) {
          ...
          if (ctx) {
            ...
            sessionStorage.setItem("thumbnailUrl", thumbnailData);
            console.log(thumbnailData);
          }
        }
      };

      // Capture thumbnail after video is loaded
      videoRef.current.addEventListener("loadedmetadata", captureThumbnail);
      return () => {
