...
const config = { FFMPEG_PATH: process.env.FFMPEG_PATH || "/usr/bin/ffmpeg", FFMPEG_TIMEOUT_MS: 30000 };
const runFfmpeg = (args, timeout = config.FFMPEG_TIMEOUT_MS) => execute(args, { ...config, FFMPEG_TIMEOUT_MS: timeout });
